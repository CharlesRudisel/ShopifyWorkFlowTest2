...
jQuery(function(){
	jQuery('.youtube-iframe').each(function(){
		...
		$imgURL = '<i class="fab fa-youtube"></i><img src="https://i.ytimg.com/vi/'+ $imgID +'/hqdefault.jpg">';
  ...
  if($('body').hasClass('template-blog') || $('body').hasClass('template-article')){
    setTimeout(function(){
      jQuery('html').find('script[src="//staticw2.yotpo.com/77wSkVVPKM0wttZgJyvHTdz74QiWCE2Y0HsTvjrY/widget.js?shop=biscuitandgravy.myshopify.com"]').remove()
    },2000);
  }
});
